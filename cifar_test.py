...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight_path',type=str,default='saved_models/image_clasification_cifar10_ResNet_1234_best.pth')
    ...
    print('Accuracy of %s is %.2f' % (args.weight_path,acc.item()))
